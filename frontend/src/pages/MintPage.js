    ...
    return (
        <section>
            ...
            <section className="claim" id="claim">
                <div className="roadmap-container"  >
                    <div className='info-container'>
                        ...
                        <Table responsive>
                            <tbody>
                                ...
                                <tr>
                                    <td className='p-2'>Max Mint Amount </td>
                    ...
                    <div className='info-container'>
                        ...
                        <Table responsive>
                            <tbody>
                                <tr>
                                    <td className='p-2'>Your SuperCrypto </td>
                ...
                <div className="roadmap-container minting" >
                    <div className='mint-container'>
                        <div className="row" style={{ justifyContent: "center" }}>
                            <div className="col-md-7">
                                <div className="text-center">
                                    <h2 className="minttitle title">
                                        Claim Your SuperCrypto Here
                                    </h2>
                                    <img src={image1} className="mint-img" alt="" />
                                    <p className="lead" style={{ marginBottom: "30px" }}>A SuperCrypto is a character that is part of an 10000 algorithmically generated collection consisting of extremely unique features ranging from faces, eyes, mouths, skins, hats, and backgrounds.</p>
            ...
            <section className='my-items'>
                {userNfts.length !== 0 ? (
                    <>
                        <h2 className="minttitle title text-center">My SuperCrypto</h2>
